...
public class Gps_map extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Gps Location");

        webView = (WebView) mainView.findViewById(R.id.website_id);
        webView.loadUrl("http://159.65.128.4:8082/");
